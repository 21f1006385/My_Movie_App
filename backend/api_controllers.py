...
class ShowApi(Resource):
    ...
    def put(self,id):
        ...
        if show:
            ...
            theatre_id=request.json.get("theatre_id")
            db.session.commit()
            return {"messate":"Show_updated"},200
        return {"message":"Showid not found!"},404
    ...
    def delete(self,id):
        ...
        if show:
            ...
            db.session.commit()
            return {"messate":"Show_deleted!"},200
...
api.add_resource(ShowApi,'/api/get_show','/api/add_show','/api/edit_show/<id>','/api/delete_show/<id>')
